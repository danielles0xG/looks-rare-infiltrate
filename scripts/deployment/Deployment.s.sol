...
contract Deployment is Script {
    ...
    function run() external {
        ...
        if (chainId == 1) {
            address INFILTRATION_ADDRESS = IMMUTABLE_CREATE2_FACTORY.safeCreate2({
            ...
            emit Log("chainId: ",chainId);
            emit Log("INFILTRATION_ADDRESS: ",INFILTRATION_ADDRESS);
            emit Log("sender: ",msg.sender);
            ...
            IMMUTABLE_CREATE2_FACTORY.safeCreate2({
                ...
                initializationCode: abi.encodePacked(
                    ...
                    abi.encode(transferManager, INFILTRATION_ADDRESS, wrappedNativeToken, looks)
                )
            });
        } else {
